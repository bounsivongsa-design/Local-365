...
function Disclaimers() {
  return (
    <div>
      ...
      <SubSection number="7" title="AI Disclaimer">
        <p>Local List 365 may provide AI-generated content for informational purposes only. Such content may not always be accurate, complete, or current. AI-generated responses do not constitute professional advice of any kind. Users should independently verify any information before making decisions based on it.</p>
      </SubSection>
    </div>
  );
}
